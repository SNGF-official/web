            ...
            <div className="loader">
                <svg height={0} width={0} viewBox="0 0 70 70" className="absolute">
                    <defs xmlns="http://www.w3.org/2000/svg">
                        ...
                        <linearGradient id="c" x1={0} y1={70} x2={0} y2={0} gradientUnits="userSpaceOnUse">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 70 70" height={70} width={68}
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 68 68" height={70} width={70}
                     className="inline-block">
                    <path
                        strokeLinejoin="round"
                        strokeLinecap="round"
