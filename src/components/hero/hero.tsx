...
const HeroSection: React.FC = () => {
  return (
    <section
             className="sm:w-full relative w-full flex items-center justify-center min-h-screen sm:pb-16 lg:pb-20 xl:pb-40 bg-[var(--bg-color)]">
      <img src={SVGWaveTop} alt="Vague du haut" className="absolute top-0 left-0 w-full **w-1/2** h-auto"
           style={{ fill: 'white' }} />
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="relative">
          ...
          <div className="lg:w-1/2 md:w-1/2">
            ...
            <h1
              className="text-[var(--base-green)] mt-6 text-4xl font-normal sm:mt-10 sm:text-5xl lg:text-6xl xl:text-8xl">
              <span className="text-black sm:text-black md:text-black lg:text-white">SILO NATIONAL</span> DES GRAINES
              FORESTIÈRES
            </h1>
          ...
          {/* Image Hero */}
          <div
            className="mt-8 md:absolute md:mt-0 md:top-32 md:right-[-100px] md:w-1/2">
            <img
