      ...
      <div className="px-4 mx-auto w-screen sm:px-6 lg:px-8 z-10">
        <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-10">
          {/* Image à gauche */}
            ...
            >
              <motion.img
                ...
                className="w-full max-w-xs mx-auto md:max-w-lg xl:max-w-xl object-contain"
          ...
          <div className="md:w-1/2 max-w-4xl">
            ...
            >
              <h1
                className="text-[var(--base-green)] mt-1 text-4xl font-normal sm:mt-10 sm:text-5xl lg:text-6xl xl:text-8xl">
              <span
                className="text-[var(--base-green)] sm:text-[var(--base-green)] md:text-[var(--base-green)] lg:text-[var(--base-green)]">
                SILO
              </span>
                {' '}
                NATIONAL
